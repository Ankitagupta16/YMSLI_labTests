...
class ThreadRandomize implements Runnable {
	...
	public static void main(String args[]) throws InterruptedException {
		...
		ThreadRandomize rt1 = new ThreadRandomize();
		ThreadRandomize rt2 = new ThreadRandomize();
		ThreadRandomize rt3 = new ThreadRandomize();
		ThreadRandomize rt4 = new ThreadRandomize();
		ThreadRandomize rt5 = new ThreadRandomize();
